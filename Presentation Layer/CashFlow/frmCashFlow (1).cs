...
namespace BSMIS 
{
    public partial class frmCashFlow : Form
    {
        ...
        private void GenerateResult()
        {
            ...
            _dsFinalResult = _cf.GenerateCashFlow(_finYear, _fromPeriod, _toPeriod, _tableProjects);
            ...
            _Header1 = "Capacite Infra Projects - Cash Flow ";
