    ...
    public partial class frmDumps : Form
    {
       ...
       private void btnClose_Click(object sender, EventArgs e)
        ...
        private void ReformatResultSet()
        {
            ...
            _dsFinalResult.Tables[0].Columns[31].Caption = "TransID";
            _dsFinalResult.Tables[0].Columns[32].Caption = "GRN";
        ...
        private void LoadDetail(DataTable _dt)
        {
            ...
            ggDetail.TableDescriptor.Columns[6].Appearance.AnyCell.CellType = "Date";
            ...
            ggDetail.TableDescriptor.Columns[31].HeaderText = "TransID";
            ggDetail.TableDescriptor.Columns[31].Width = 50;
            ggDetail.TableDescriptor.Columns[31].AllowGroupByColumn = true;

            ggDetail.TableDescriptor.Columns[32].HeaderText = "GRN";
            ggDetail.TableDescriptor.Columns[32].Width = 50;
            ggDetail.TableDescriptor.Columns[32].AllowGroupByColumn = false ;
