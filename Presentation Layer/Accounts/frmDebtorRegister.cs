...
namespace BSMIS 
{
    public partial class frmDebtorRegister : Form
    {
        int _CurrentFinYear;
        int _CurrentMonth;
        ...
        private void frmCreditorAge_Load(object sender, EventArgs e)
        {
            ...
            lblHeader.Text = "Debtor Register";
        ...
        private void LoadListDebtors()
        {
            _ds = _cg.GetDebtorsInYear(_CurrentFinYear);
        ...
        private void GenerateResult()
        {
            ...
            _dt = new DataTable();
            _dsFinalResult = _cg.DebtorRegister(_finYear, _fromPeriod, _toPeriod, _tableCreditors, _tableProjects);
        ...
        private void LoadDetail(DataTable _dt)
        {
            ...
            gridRegister.TableDescriptor.Columns[4].Width = 0;

            gridRegister.TableDescriptor.Columns[5].HeaderText = "Month";
            ...
            int _colCnt = _dt.Columns.Count - 9;
