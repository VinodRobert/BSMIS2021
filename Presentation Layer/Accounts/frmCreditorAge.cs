    ...
    public partial class frmSubbieAge : Form
    {
        ...
        private void LoadCombos()
        {
            ...
            if (GlobalVariables.AgeOf == 3)
            {
                ...
                UtilityFunctions.LoadWindowsCombo(cmbDebtors, _dsD.Tables[0], "DEBTNAME", "DEBTNUMBER", 0);
        ...
        private void GeneateCreditorTable()
        {
            ...
            if (chkAll.Checked == true)
            {
                ...
                {
                    _tableCreditors.Rows.Add(Convert.ToString(_dtCreditors.Rows[i][0]));
                }
        ...
        private void GeneateOrgTable()
        {
            ...
            if (chkAll.Checked == true)
            {
                ...
                {
                    _tableProjects.Rows.Add(Convert.ToString(_dtProject.Rows[i][0]));
                }
            }
            else
            {
