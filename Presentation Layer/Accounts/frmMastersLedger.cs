...
namespace BSMIS 
{
    public partial class frmMastersLedger : Form
    {
        int _CurrentFinYear;
        int _CurrentMonth;
        ...
        DataSet _dsToPeriod;
        DataSet _dsCreditors;
        DataSet _dsSubContractors;
        DataSet _dsDebtors; 


        DataTable _dtCreditors = new DataTable();
        DataTable _dtSubContractors = new DataTable();
        DataTable _dtDebtors = new DataTable();
        ...
        private void LoadCombos()
        {
            ...
            _dsToYear = _cg.GetFinancialYearsForLedgerReports();
        ...
        private void SetMasterCombo()
        {
            cmbMasters.Items.Add("Creditors");
            cmbMasters.Items.Add("Sub Contractors");
            cmbMasters.Items.Add("Debtors - Sale");
            cmbMasters.Items.Add("Debtors - Staff");
            cmbMasters.Items.Add("Debtors - Scrap");
            cmbMasters.Items.Add("Other Ledgers");
            cmbMasters.Sorted = false;
            cmbMasters.SelectedItem = "Creditors";
        }
       ...
       private void btnClose_Click(object sender, EventArgs e)
        ...
        private void GenerateResult()
        {
            ...
            _who = Convert.ToString(cmbMasters.Text);
            if (_who == "Creditors")
                _ledgercode = "1315000";
            else if (_who == "Sub Contractors")
                _ledgercode = "1320000";
            else if (_who == "Debtors - Sale")
                _ledgercode = "2540000";
            else if (_who == "Debtors - Staff")
                _ledgercode = "2540001";
            else if (_who == "Debtors - Scrap")
                _ledgercode = "2540002";
            else
                _ledgercode = "0";
            ...
            string _partyCode;
            _partyCode = Convert.ToString(cmbParty.SelectedValue.ToString());

            _dsFinalResult = new DataSet();
            _dsFinalResult = _cg.GetLedgerSummary(_tableProjects, _ledgercode, _partyCode, _fromYear, _fromPeriod, _toYear, _toPeriod);
        ...
        {
            _dsCreditors = _cg.GetCreditorsOrdered();
            UtilityFunctions.LoadWindowsCombo(cmbParty, _dsCreditors.Tables[0], "CREDNAME", "CREDNUMBER", 0);
            cmbParty.SelectedValue = 0;
        }

        private void LoadSubContractors()
        {
            _dsSubContractors = _cg.GetSubbieOrdered();
            UtilityFunctions.LoadWindowsCombo(cmbParty, _dsSubContractors.Tables[0], "CREDNAME", "CREDNUMBER", 0);
        }

        private void LoadDebtors_Sale()
        {
            _dsDebtors = _cg.GetDebtorsOrdered_Sale();
            UtilityFunctions.LoadWindowsCombo(cmbParty, _dsDebtors.Tables[0], "CREDNAME", "CREDNUMBER", 0);
            cmbParty.SelectedValue = 0;
            
        }

        private void LoadDebtors_Staff()
        {
            _dsDebtors = _cg.GetDebtorsOrdered_Staff();
            UtilityFunctions.LoadWindowsCombo(cmbParty, _dsDebtors.Tables[0], "CREDNAME", "CREDNUMBER", 0);
            cmbParty.SelectedValue = 0;

        }

        private void LoadDebtors_Scrap()
        {
            _dsDebtors = _cg.GetDebtorsOrdered_Scrap();
            UtilityFunctions.LoadWindowsCombo(cmbParty, _dsDebtors.Tables[0], "CREDNAME", "CREDNUMBER", 0);
            cmbParty.SelectedValue = 0;

        }

        private void LoadOtherLedgers()
        {
            _dsDebtors = _cg.LoadOtherLedgers();
            UtilityFunctions.LoadWindowsCombo(cmbParty, _dsDebtors.Tables[0], "CREDNAME", "CREDNUMBER", 0);
            cmbParty.SelectedValue = 0;
        ...
        private void cmbMasters_SelectionChangeCommitted(object sender, EventArgs e)
        {
            cmbParty.Visible = false;
            string _masterName;
            _masterName = Convert.ToString(cmbMasters.Text);
            if (_masterName == "Creditors")
                LoadCreditors();
            else if (_masterName == "Sub Contractors")
                LoadSubContractors();
            else if (_masterName == "Debtors - Sale")
                LoadDebtors_Sale();
            else if (_masterName == "Debtors - Staff")
                LoadDebtors_Staff();
            else if (_masterName == "Debtors - Scrap")
                LoadDebtors_Scrap();
            else if (_masterName == "Other Ledgers")
                LoadOtherLedgers();
