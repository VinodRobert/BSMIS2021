...
namespace BSMIS 
{
    public partial class frmSubContractorRegister : Form
    {
        int _CurrentFinYear;
        int _CurrentMonth;
        ...
        public frmSubContractorRegister()
        {
            InitializeComponent();
        }
        ...
        private void frmCreditorAge_Load(object sender, EventArgs e)
        {
            ...
            lblHeader.Text = "Sub Contractor Register";
        ...
        private void LoadListSubbie()
        {
            _ds = _cg.GetSubbiesInYear(_CurrentFinYear);
                ...
                if (_dsEx != null && _dsEx.Tables.Count > 0)
                {
                    using (ExcelPackage xp = new ExcelPackage())
                    {
                        foreach (DataTable dt in _dsEx.Tables)
                        {
                            ...
                            dt.TableName = " Sub Contractor  Register ";
                        ...
                        string _fileName="SubConRegister";
        ...
        private void EnableProgressBar(int i)
        {
            if (i == 1)
            {
                pbar.Visible = true;
        ...
        private void GenerateResult()
        {
            ...
            _dt = new DataTable();
            _dsFinalResult = _cg.SubbieRegister(_finYear, _fromPeriod, _toPeriod, _tableCreditors, _tableProjects);
            _dt = _dsFinalResult.Tables[0];
            
            
            _Header1 = "Capacite Infra Projects - Sub Contractor Register";
        ...
        private void LoadDetail(DataTable _dt)
        {
            ...
            gridRegister.TableDescriptor.Columns[1].Width = 200;
            ...
            gridRegister.TableDescriptor.Columns[5].HeaderText = "Posting Date";
            ...
            gridRegister.TableDescriptor.Columns[6].Width = 75;
            ...
            //gridRegister.TableDescriptor.Columns[7].HeaderText = "Inv.Date";
            ...
            int _colCnt = _dt.Columns.Count - 7;
            for (int i = 7; i <= _colCnt; i++)
            {
