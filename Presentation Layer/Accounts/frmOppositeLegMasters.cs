...
namespace BSMIS 
{
    public partial class frmOppositeLegMasters : Form
    {
        int _CurrentFinYear;
        int _CurrentMonth;
        ...
        private void frmCreditorAge_Load(object sender, EventArgs e)
        {
            ...
            lblHeader.Text = "Ledger Report (Opposite Legs - Masters)";
        ...
        public void ResetAll()
        {
            ...
            cmbVendorCode.Text = "Select Party";
        }
       ...
       //     string _query = "SELECT LEDGERCODE,UPPER(LEDGERNAME) LEDGERNAME FROM LEDGERCODES WHERE LEDGERSUMMARY=0 AND LEDGERALLOC IN ('Contracts') AND LEDGERSTATUS=0 AND LEDGERNAME<>'' ORDER BY LEDGERNAME  ";
        ...
        private void GenerateResult()
        {
            ...
            if (cmbVendorCode.Text == "")
            {
                MessageBox.Show("Hi  You Did not Select a Party !!");
                return;
            }
        ...
        private void LoadDetail(DataTable _dt)
        {
            ...
            gridRegister.TableDescriptor.Columns[5].Width = 165;
            ...
            gridRegister.TableDescriptor.Columns[10].Width =225;
        ...
        private void btnFetch_Click(object sender, EventArgs e)
        {
            if (btnFetch.Text == "Fetch")
            {
                ...
                dtMasterItems = null;
                if (masterID == 10)
                    dsMasterItems = _cg.GetCreditorsCommon();
                if (masterID == 13)
                    dsMasterItems = _cg.GetSubContractorsCommon();
                if (masterID == 11)
                    dsMasterItems = _cg.GetDebtorsCommon();
