...
namespace BSMIS 
{
    public partial class frmGSTPurchase : Form
    {
        int _CurrentFinYear;
        int _CurrentMonth;
        ...
        private void GenerateResult()
        {
            ...
            _dsFinalResult = _gst.GSTPurchase(_finYear,_fromPeriod, _toPeriod,  _tableProjects, _tableCILGSTN, _tableDocmentType, _tableGSTType);
        ...
        private void LoadDetail(DataTable _dt)
        {
            ...
            gridRegister.TableDescriptor.Columns[4].Width = 55;
            ...
            gridRegister.TableDescriptor.Columns[34].HeaderText = "TransGroup";
            gridRegister.TableDescriptor.Columns[34].Width = 100;
            gridRegister.TableDescriptor.Columns[34].AllowGroupByColumn = false;

            gridRegister.TableDescriptor.Columns[35].HeaderText = "TransID";
            gridRegister.TableDescriptor.Columns[35].Width = 100;
            gridRegister.TableDescriptor.Columns[35].AllowGroupByColumn = false;
