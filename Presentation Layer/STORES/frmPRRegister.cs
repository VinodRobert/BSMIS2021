...
namespace BSMIS 
{
    public partial class frmPRRegister : Form
    {
        ...
        private void frmCreditorAge_Load(object sender, EventArgs e)
        {
            ...
            LoadListZone();
            LoadListProject();
            lblHeader.Text = "Requisition  Register";
                ...
                if (_dsEx != null && _dsEx.Tables.Count > 0)
                {
                    using (ExcelPackage xp = new ExcelPackage())
                    {
                        foreach (DataTable dt in _dsEx.Tables)
                        {
                            ...
                            dt.TableName = " Requisition Register ";
        ...
        private void GenerateResult()
        {
            ...
            _dsFinalResult = _cg.PRRegister(_fromDate, _toDate,  _tableProjects);
            _dt = _dsFinalResult.Tables[0];
            
            
            _Header1 = "Capacite Infra Projects - Requisition Register";
        ...
        private void LoadDetail(DataTable _dt)
        {
            ...
            gridRegister.TableDescriptor.Columns[0].HeaderText = "Status";
            gridRegister.TableDescriptor.Columns[0].Width = 150;
            gridRegister.TableDescriptor.Columns[0].AllowFilter = true;

            gridRegister.TableDescriptor.Columns[1].HeaderText = "Approver";
            gridRegister.TableDescriptor.Columns[1].Width = 100;
            gridRegister.TableDescriptor.Columns[1].AllowFilter = true;


            gridRegister.TableDescriptor.Columns[2].HeaderText = "SuppCode";
            gridRegister.TableDescriptor.Columns[2].Width = 100;
            ...
            gridRegister.TableDescriptor.Columns[4].HeaderText = "Project";
            gridRegister.TableDescriptor.Columns[4].Width = 250;
            gridRegister.TableDescriptor.Columns[4].AllowFilter = true;
 
     

            gridRegister.TableDescriptor.Columns[5].HeaderText = "Req #";
            gridRegister.TableDescriptor.Columns[5].Width = 150;
            gridRegister.TableDescriptor.Columns[5].AllowFilter = true;
            gridRegister.TableDescriptor.Columns[5].AllowGroupByColumn = false;

            gridRegister.TableDescriptor.Columns[6].HeaderText = "Req Subject";
            gridRegister.TableDescriptor.Columns[6].Width = 150;
            gridRegister.TableDescriptor.Columns[6].AllowFilter = true;
            gridRegister.TableDescriptor.Columns[6].AllowGroupByColumn = false;

            gridRegister.TableDescriptor.Columns[7].HeaderText = "Short Desc";
            gridRegister.TableDescriptor.Columns[7].Width = 150;
            gridRegister.TableDescriptor.Columns[7].AllowFilter = true;
            gridRegister.TableDescriptor.Columns[7].AllowGroupByColumn = false;


            gridRegister.TableDescriptor.Columns[8].HeaderText = "PR Date";
            ...
            gridRegister.TableDescriptor.Columns[9].HeaderText = "SlNo";
            gridRegister.TableDescriptor.Columns[9].Width = 0;
            gridRegister.TableDescriptor.Columns[9].AllowFilter = true;


            gridRegister.TableDescriptor.Columns[10].HeaderText = "Item Description";
            gridRegister.TableDescriptor.Columns[10].Width = 300;
            gridRegister.TableDescriptor.Columns[10].AllowFilter = false;
      
            gridRegister.TableDescriptor.Columns[11].HeaderText = "Stock ID";
            gridRegister.TableDescriptor.Columns[11].Width = 250;
            gridRegister.TableDescriptor.Columns[11].AllowFilter = true;

            gridRegister.TableDescriptor.Columns[12].HeaderText = "Unit";
            gridRegister.TableDescriptor.Columns[12].Width = 50;
            gridRegister.TableDescriptor.Columns[12].AllowGroupByColumn = false;

            gridRegister.TableDescriptor.Columns[13].HeaderText = "Quantity";
            gridRegister.TableDescriptor.Columns[13].Width = 70;
            gridRegister.TableDescriptor.Columns[13].AllowGroupByColumn = false;

            gridRegister.TableDescriptor.Columns[14].HeaderText = "Rate";
            ...
            gridRegister.TableDescriptor.Columns[15].HeaderText = "Discount %";
            ...
            gridRegister.TableDescriptor.Columns[16].HeaderText = "Amount";
            ...
            gridRegister.TableDescriptor.Columns[17].HeaderText = "Ledger Code";
            gridRegister.TableDescriptor.Columns[17].Width = 80;
            gridRegister.TableDescriptor.Columns[17].AllowGroupByColumn = false;
           

            gridRegister.TableDescriptor.Columns[18].HeaderText = "Ledger Name";
