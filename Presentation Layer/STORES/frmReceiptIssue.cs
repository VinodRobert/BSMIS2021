...
namespace BSMIS 
{
    public partial class frmReceiptIssue : Form
    {
                ...
                if (_dsEx != null && _dsEx.Tables.Count > 0)
                {
                    using (ExcelPackage xp = new ExcelPackage())
                    {
                        foreach (DataTable dt in _dsEx.Tables)
                        {
                            ...
                            dt.TableName = " Receipt-Issue Register ";
        ...
        private void GenerateResult()
        {
            ...
            _dsFinalResult = _st.ReceiptIssue(_fromPeriod, _toPeriod, _finYear, _tableProjects);
            ...
            _Header1 = "Capacite Infra Projects - Receipt-Issue Register";
        ...
        private void LoadDetail(DataTable _dt)
        {
            ...
            gridRegister.TableDescriptor.Columns[0].HeaderText = "BorgID";
            gridRegister.TableDescriptor.Columns[0].Width = 50;
            gridRegister.TableDescriptor.Columns[0].AllowFilter = true;

            gridRegister.TableDescriptor.Columns[1].HeaderText = "Borg Name";
            ...
            gridRegister.TableDescriptor.Columns[2].HeaderText = "StoreCode";
            gridRegister.TableDescriptor.Columns[2].Width = 55;
            gridRegister.TableDescriptor.Columns[2].AllowGroupByColumn = false;

            gridRegister.TableDescriptor.Columns[3].HeaderText = "Store Name";
            gridRegister.TableDescriptor.Columns[3].Width = 200;
            gridRegister.TableDescriptor.Columns[3].AllowFilter = true;


            gridRegister.TableDescriptor.Columns[4].HeaderText = "StockCode";
            ...
            gridRegister.TableDescriptor.Columns[5].Width = 190;
            ...
            gridRegister.TableDescriptor.Columns[8].HeaderText = "Receipt Value";
            ...
            gridRegister.TableDescriptor.Columns[9].HeaderText = "Issues";
            ...
            gridRegister.TableDescriptor.Columns[10].HeaderText = "Issue Value";
