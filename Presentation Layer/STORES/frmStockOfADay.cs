...
namespace BSMIS 
{
    public partial class frmStockOfADay : Form
    {
        ...
        private void GenerateResult()
        {
            ...
            _dt = new DataTable();
            _dsFinalResult = _st.StockOfADay(_fromDate,_tableInventory, _tableProjects);
            _dt = _dsFinalResult.Tables[0];



            _Header1 = "Capacite Infra Projects - Stock Of A Day  Report";
        ...
        private void LoadDetail(DataTable _dt)
        {
            ...
            gridRegister.TableDescriptor.Columns[4].Appearance.AnyCell.Format = "F4";
