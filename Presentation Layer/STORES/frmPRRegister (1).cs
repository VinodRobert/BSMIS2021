...
namespace BSMIS 
{
    public partial class frmPRRegister : Form
    {
        ...
        private void GenerateResult()
        {
            ...
            _dsFinalResult = _cg.PRRegister(_fromDate, _toDate, _tableCreditors, _tableProjects);
        ...
        private void LoadDetail(DataTable _dt)
        {
            ...
            gridRegister.TableDescriptor.Columns[1].HeaderText = "SuppCode";
            ...
            gridRegister.TableDescriptor.Columns[4].HeaderText = "Req #";
            gridRegister.TableDescriptor.Columns[4].Width = 150;
            gridRegister.TableDescriptor.Columns[4].AllowFilter = true;
            gridRegister.TableDescriptor.Columns[4].AllowGroupByColumn = false;

            gridRegister.TableDescriptor.Columns[5].HeaderText = "Req Subject";
            ...
            gridRegister.TableDescriptor.Columns[6].HeaderText = "Short Desc";
            ...
            gridRegister.TableDescriptor.Columns[7].HeaderText = "PR Date";
            gridRegister.TableDescriptor.Columns[7].Width = 65;
            ...
            gridRegister.TableDescriptor.Columns[8].HeaderText = "SlNo";
            gridRegister.TableDescriptor.Columns[8].Width = 0;
            gridRegister.TableDescriptor.Columns[8].AllowFilter = true;


            gridRegister.TableDescriptor.Columns[9].HeaderText = "Item Description";
            gridRegister.TableDescriptor.Columns[9].Width = 300;
            gridRegister.TableDescriptor.Columns[9].AllowFilter = false;
      
            gridRegister.TableDescriptor.Columns[10].HeaderText = "Stock ID";
            gridRegister.TableDescriptor.Columns[10].Width = 250;
            gridRegister.TableDescriptor.Columns[10].AllowFilter = true;

            gridRegister.TableDescriptor.Columns[11].HeaderText = "Unit";
            gridRegister.TableDescriptor.Columns[11].Width = 50;
            gridRegister.TableDescriptor.Columns[11].AllowGroupByColumn = false;

            gridRegister.TableDescriptor.Columns[12].HeaderText = "Quantity";
            gridRegister.TableDescriptor.Columns[12].Width = 70;
            ...
            gridRegister.TableDescriptor.Columns[14].HeaderText = "Discount %";
            ...
            gridRegister.TableDescriptor.Columns[15].HeaderText = "Amount";
