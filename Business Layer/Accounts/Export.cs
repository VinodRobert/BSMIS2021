...
namespace BSMIS 
{
    class Export
    {
        ...
        private void ExportToExcel(DataSet _dsExport)
        {
            #region Initialize Variables
            System.Data.DataTable dataGridView1 = new System.Data.DataTable();

            //Load source
            dataGridView1 = _dsExport.Tables[0];
            ...
            {
                iCol++;
                xlWorkSheet.Cells[2, iCol] = dataGridView1.Columns[iCol - 1].HeaderText;
            }
